            ...
            if(!$result)
            {
                die("Query failed".mysqli_error($connection));
                    ...
                    <tr class="table-row">
                            ...
                            <td class="march">
                               <a href='add.php?qid=<?php echo $qid?>&value=delete&cid=<?php echo $cid;?>'>Delete</a> 
                            </td>
                          <td><a href='updatequestion.php?qid=<?php echo $qid;?>&value=update&cid=<?php echo $cid;?>'>update</a></td>
